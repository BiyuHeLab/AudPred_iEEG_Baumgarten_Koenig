...
%Aim: Filter (0.1-30Hz) data containing interspersed NaNs and interpolate
        ...
        if ~isempty(index_nanelects)
            ...
            if save_poststepFigs == 1
                path_fig = [paths_NASTD_ECoG.Preproc_ECoGdata sub ...
                    '/Figs/Preproc/FiltInterp/HP01HzLP30Hz/' ];
                if (~exist(path_fig, 'dir')); mkdir(path_fig); end

                filename     = strcat([sub '_FiltInterp_HP01HzLP30Hz_TD' TD_label ...
