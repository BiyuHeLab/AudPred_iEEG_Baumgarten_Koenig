function stim_corr(sub, DV_ind, phase_option)
...
mkdir([si.path_analysis 'stimulus_tracking/stim_corr/stim_corr_results/'], sub);
path_out = [si.path_analysis 'stimulus_tracking/stim_corr/stim_corr_results/' sub '/'];
...
switch phase_option
    ...
    otherwise
        savefile = [path_out sub '_stim_corr_' DV '.mat'];    
end
