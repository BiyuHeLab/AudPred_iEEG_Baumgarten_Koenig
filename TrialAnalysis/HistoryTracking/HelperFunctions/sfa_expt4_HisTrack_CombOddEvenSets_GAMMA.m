function sfa_expt4_HisTrack_CombOddEvenSets_GAMMA(sub, tonedur_text, baseline_correct)
...
load([path_load sub '_HisTrackGAMMAEnvSLIDE16_regstatsEXP_' BC_text '_' tonedur_title 'msToneDur_trainEven.mat']);
...
load([path_load sub '_HisTrackGAMMAEnvSLIDE16_regstatsEXP_' BC_text '_' tonedur_title 'msToneDur_trainOdd.mat']);
...
savefile = [path_save sub '_HisTrackGAMMAEnvSLIDE16_regstatsEXP_' BC_text '_' tonedur_title 'msToneDur_kModelComp_CombSets.mat'];
