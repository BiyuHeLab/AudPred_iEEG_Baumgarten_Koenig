function sfa_expt4_HisTrack_CompSaveShuffledKval_GAMMA(sub, baseline_correct, train_odd, tonedur_text, nReps)
...
%8.2 save output var
savefile = [path_save sub '_HisTrackGAMMAEnvSLIDE16_regstatsSHUFFLED' num2str(nReps) 'Reps_' BC_text '_' tonedur_title 'msToneDur_' oddity_text '.mat'];
