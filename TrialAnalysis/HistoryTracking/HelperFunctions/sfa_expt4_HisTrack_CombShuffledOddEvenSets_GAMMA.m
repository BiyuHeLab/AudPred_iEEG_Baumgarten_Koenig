function sfa_expt4_HisTrack_CombShuffledOddEvenSets_GAMMA(sub, tonedur_text, baseline_correct, nReps, IdentShuffleOrder_AllTineDur, ShuffleSets)
...
if IdentShuffleOrder_AllTineDur == 1
    load([path_load_SHUFFLEDk sub '_HisTrackGAMMAEnvSLIDE16_regstatsSHUFFLEDidentical' num2str(nReps) 'Reps_' BC_text '_' tonedur_title 'msToneDur_trainEven.mat']);
else
    load([path_load_SHUFFLEDk sub '_HisTrackGAMMAEnvSLIDE16_regstatsSHUFFLED' num2str(nReps) 'Reps_' BC_text '_' tonedur_title 'msToneDur_trainEven.mat']);
end
...
if IdentShuffleOrder_AllTineDur == 1
    load([path_load_SHUFFLEDk sub '_HisTrackGAMMAEnvSLIDE16_regstatsSHUFFLED_IdentRepsAllToneDur_' nReps 'Reps_' BC_text '_' tonedur_title 'msToneDur_trainOdd.mat']);
else
    load([path_load_SHUFFLEDk sub '_HisTrackGAMMAEnvSLIDE16_regstatsSHUFFLED' num2str(nReps) 'Reps_' BC_text '_' tonedur_title 'msToneDur_trainOdd.mat']);
end
...
load([path_load_EXPk sub '_HisTrackGAMMAEnvSLIDE16_regstatsEXP_' BC_text '_' tonedur_title 'msToneDur_kModelComp_CombSets.mat']);
...
if IdentShuffleOrder_AllTineDur == 1
    if strcmp(ShuffleSets, 'appended')
        savefile = [path_save sub '_HisTrackGAMMAEnvSLIDE16_regstatsSHUFFLEDidentical' num2str(nReps) '_' BC_text '_' tonedur_title 'msToneDur_kModelComp_appSets.mat'];
    elseif strcmp(ShuffleSets, 'averaged')           
        savefile = [path_save sub '_HisTrackGAMMAEnvSLIDE16_regstatsSHUFFLEDidentical' num2str(nReps) '_' BC_text '_' tonedur_title 'msToneDur_kModelComp_avgSets.mat'];
    end
else
    if strcmp(ShuffleSets, 'appended')
        savefile = [path_save sub '_HisTrackGAMMAEnvSLIDE16_regstatsSHUFFLED' num2str(nReps) 'Reps_' BC_text '_' tonedur_title 'msToneDur_kModelComp_appSets.mat']; %for appended shufle sets
    elseif strcmp(ShuffleSets, 'averaged')           
        savefile = [path_save sub '_HisTrackGAMMAEnvSLIDE16_regstatsSHUFFLED' num2str(nReps) 'Reps_' BC_text '_' tonedur_title 'msToneDur_kModelComp_avgSets.mat']; %for averaged shuffle sets
    end
end
