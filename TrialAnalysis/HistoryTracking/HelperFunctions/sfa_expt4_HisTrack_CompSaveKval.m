function sfa_expt4_HisTrack_CompSaveKval(sub, baseline_correct, train_odd, tonedur_text)
...
%2.2 Select trials with specific tone length 
...
% mean(data_ECoGfiltref_trials_test.behav.correct_uSeq)
...
%8.2 save output var
savefile = [path_save sub '_HisTrackSLIDE16_regstatsEXP_' BC_text '_' tonedur_title 'msToneDur_' oddity_text '.mat'];
%savefile = [path_save sub '_HisTrackSLIDE16_DetrendLNHP.05Hz_regstatsEXP_' BC_text '_' tonedur_title 'msToneDur_' oddity_text '.mat'];
