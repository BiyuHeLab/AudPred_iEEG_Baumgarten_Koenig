function c = NASTD_Plot_PlotSignElecsSurf...
    (coords, vals, sign_index, chanSize,...
    clims, cmap,...
    view_angle)
...
% h.Position(2) = 0.2; %sets colorbar higher
% h.Position(4) = h.Position(4)*1.6; %makes colorbar shorter
