        ...
        for i_TD = 1:length(ToneDur_text)
            ...
            for i_sourceelec = 1:length(GCdata{i_sub}.ind_pairedelecs_from)
                for i_targetelec = 1:length(GCdata{i_sub}.ind_pairedelecs_to)
                    ...
                    title(['From ' GCdata{i_sub}.label_allelecs{GCdata{i_sub}.ind_pairedelecs_from(i_sourceelec)} ' to ' ...
                ...
                for i_targetelec = 1:length(GCdata{i_sub}.ind_pairedelecs_to)
                    ...
                    for i_tonegroup = 1:length(param.GC.tone_aggregation)
                        plot(meandata_line(i_tonegroup,:), ...
                            'Color', colormap_cool(50*i_tonegroup,:), 'LineWidth', 2);
                    end
                    ...
                    title(['From ' GCdata{i_sub}.label_allelecs{GCdata{i_sub}.ind_pairedelecs_from(i_sourceelec)} ...
                        ' to ' GCdata{i_sub}.label_allelecs{GCdata{i_sub}.ind_pairedelecs_to(i_targetelec)}])
                end
            end
            ...
            for i_sourceelec = 1:length(GCdata{i_sub}.ind_pairedelecs_from)
                for i_targetelec = 1:length(GCdata{i_sub}.ind_pairedelecs_to)
                    ...
                    title(['From ' GCdata{i_sub}.label_allelecs{GCdata{i_sub}.ind_pairedelecs_to(i_targetelec)} ...
                        ' to ' GCdata{i_sub}.label_allelecs{GCdata{i_sub}.ind_pairedelecs_from(i_sourceelec )}])
                end
            end
