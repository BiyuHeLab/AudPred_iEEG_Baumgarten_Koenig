...
%Aim: Filter (broadband 0.5-150Hz) data containing interspersed NaNs and interpolate
        ...
        if ~isempty(index_nanelects)
            ...
            if save_poststepFigs == 1
                path_fig = [paths_NASTD_ECoG.Preproc_ECoGdata sub ...
                    '/Figs/Preproc/FiltInterp/HP05HztoLP150Hz/' ];
                if (~exist(path_fig, 'dir')); mkdir(path_fig); end

                filename     = strcat([sub '_FiltInterp_HP05HztoLP150Hz_TD' TD_label ...
