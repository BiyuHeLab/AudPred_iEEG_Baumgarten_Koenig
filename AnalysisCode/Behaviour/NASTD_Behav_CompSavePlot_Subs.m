...
if i_sub < 4 %only first 3 patients had task2
    addpath(paths_NASTD.ScriptsDir) %necessary for dprime function
...
% addpath(paths_NASTD.ScriptsDir) %necessary for figd function
...
% %Compute 3-way ANOVA (factors: TD, p34, predp34)
% varnames = {'ToneDur'; 'predp34'; 'p34'}; %variable labeling for ANOVA3
% 
% [~, tbl{i_sub}] = anovan([FTPLrating_anova2{i_sub}{1}.PredRating; FTPLrating_anova2{i_sub}{2}.PredRating], ...
%     {[FTPLrating_anova2{i_sub}{1}.ToneDur; FTPLrating_anova2{i_sub}{2}.ToneDur] ...
%     [FTPLrating_anova2{i_sub}{1}.Expected; FTPLrating_anova2{i_sub}{2}.Expected] ...
%     [FTPLrating_anova2{i_sub}{1}.Actual; FTPLrating_anova2{i_sub}{2}.Actual]},...
%     'model', 'interaction', 'varnames', varnames, 'display', 'off');
% BehavData_SingleSub.FTPLrating_anova3 = tbl{i_sub};
% 
...
mkdir([paths_NASTD.Analysis_Behavior sub '/'])
save([paths_NASTD.Analysis_Behavior sub '/' 'BehavData.mat'], 'BehavData_SingleSub')
