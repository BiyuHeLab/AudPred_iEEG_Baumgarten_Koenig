...
inputData_label = { 'HP05toLP30Hz','HighGamma_LogAmp'};
...
for i_inputData = 1:length(inputData_label)
    ExpKprime_data_perTW_all = nan(3, 4);
    for i_TD = 1:length(ToneDur_label)
        
        %plot figure
        NASTD_ECoG_HisTrack_PlotSignExpKvals_AllSubperTW_lk...
            (sub_list(vars.validSubjs), ToneDur_label{i_TD}, inputData_label{i_inputData}, ...
            SamplesTW, Label_TW,...
            param, ...
            FDR_correct, pval_threshold,...
        ...
        % Plot figure by subject color for different values of k'
        NASTD_ECoG_HisTrack_PlotSignExpKvals_BySubjColor...
            (sub_list(vars.validSubjs), ToneDur_label{i_TD}, inputData_label{i_inputData}, ...
            SamplesTW, Label_TW,...
            param, ...
            FDR_correct, pval_threshold,...
        ...
        % extract table
%         ExpKprime_data_perTW = NASTD_ECoG_HisTrack_ExtractSignExpKvals_AllSubperTW_forTable...
%             (sub_list(vars.validSubjs), ToneDur_label{i_TD}, inputData_label{i_inputData}, ...
%             SamplesTW, Label_TW,...
%             param, ...
%             FDR_correct, pval_threshold,...
...
%         
%         if i_TD == 1
%             ExpKprime_data_perTW_all(1,:) = mean(ExpKprime_data_perTW,1);
%         elseif i_TD == 2
%             ExpKprime_data_perTW_all(2,:) = mean(ExpKprime_data_perTW(:,1:4),1);
%             ExpKprime_data_perTW_all(3,:) = mean(ExpKprime_data_perTW(:,5:8),1);
%         end
...
%     columnNames = {'TW1', 'TW2', 'TW3', 'TW4'};
%     rowNames = {'TD1', 'TD2_1', 'TD2_2'};
%     myTable = array2table(ExpKprime_data_perTW_all, 'VariableNames', columnNames, 'RowNames', rowNames);
%     writetable(myTable, ['/isilon/LFMI/VMdrive/Lua/NASTD/Kprime_data_perTW_', inputData_label{i_inputData}, '.csv'], 'WriteRowNames', true);
...
%         save_poststepFigs, paths_NASTD_ECoG)
     ...
     NASTD_ECoG_HisTrack_PlotSignExpKvalsBothTD_AllSubAvgTW_EachTD...
        (sub_list(vars.validSubjs), ToneDur_label, inputData_label{i_inputData}, ...
        SamplesTW, Label_TW, ...
        FDR_correct, pval_threshold,...
        param, ...
