function Gavg_tempGC_peranatreg = NASTD_ECoG_Connectivity_ObtainGCByAnatRegions ...
    (subs, ...
    GCdata, ...
    ToneDur_text, ...
...
%         [p_R12_p32p33, h, stats_R12_p32p33] = ...
%             signrank(...
%             Gavg_tempGC_peranatreg.source2target{i_effect}...
...
%         [p_R12_p32p34, h, stats_R12_p32p34] = ...
%             signrank(...
%             Gavg_tempGC_peranatreg.source2target{i_effect}...
%             {temp_currfilt(1),temp_currfilt(2),i_TD}(:,1), ...
%             Gavg_tempGC_peranatreg.source2target{i_effect}...
...
%         [p_R21_p32p33, h, stats_R21_p32p33] = ...
%             signrank(...
%             Gavg_tempGC_peranatreg.source2target{i_effect}...
...
%         [p_R21_p32p34, h, stats_R21_p32p34] = ...
%             signrank(...
%             Gavg_tempGC_peranatreg.source2target{i_effect}...
%             {temp_currfilt(2),temp_currfilt(1),i_TD}(:,1), ...
%             Gavg_tempGC_peranatreg.source2target{i_effect}...
...
%             {'p33vsp32', ['z = ' num2str(round(stats_R12_p32p33.zval,3)) '; p = ' num2str(round(p_R12_p32p33,3))]}, ...
%             'Color',[0 0 1])
%         text(1.3, f_sub1.YLim(2)*0.25, ...
%             {'p33vsp32', ['z = ' num2str(round(stats_R21_p32p33.zval,3)) '; p = ' num2str(round(p_R21_p32p33,3))]}, ...
%             'Color',[1 0 0])
%         text(2.3, f_sub1.YLim(2)*0.75, ...
%              {'p34vsp32', ['z = ' num2str(round(stats_R12_p32p34.zval,3)) '; p = ' num2str(round(p_R12_p32p34,3))]}, ...
%             'Color',[0 0 1])
%         text(2.3, f_sub1.YLim(2)*0.25, ...
%             {'p34vsp32', ['z = ' num2str(round(stats_R21_p32p34.zval,3)) '; p = ' num2str(round(p_R21_p32p34,3))]}, ...
%             'Color',[1 0 0])
% 
...
%         [p_R13_p32p33, h, stats_R13_p32p33] = ...
%             signrank(...
%             Gavg_tempGC_peranatreg.source2target{i_effect}...
...
%         [p_R13_p32p34, h, stats_R13_p32p34] = ...
%             signrank(...
%             Gavg_tempGC_peranatreg.source2target{i_effect}...
%             {temp_currfilt(1),temp_currfilt(3),i_TD}(:,1), ...
%             Gavg_tempGC_peranatreg.source2target{i_effect}...
...
%         %Reg2->Reg1, p32 vs. p33
%         [p_R31_p32p33, h, stats_R31_p32p33] = ...
%             signrank(...
%             Gavg_tempGC_peranatreg.source2target{i_effect}...
...
%         %Reg2->Reg1, p32 vs. p34
%         [p_R31_p32p34, h, stats_R31_p32p34] = ...
%             signrank(...
%             Gavg_tempGC_peranatreg.source2target{i_effect}...
%             {temp_currfilt(3),temp_currfilt(1),i_TD}(:,1), ...
%             Gavg_tempGC_peranatreg.source2target{i_effect}...
...
%         hold on;
%         text(1.3, f_sub1.YLim(2)*0.75, ...
%             {'p33vsp32', ['z = ' num2str(round(stats_R13_p32p33.zval,3)) '; p = ' num2str(round(p_R13_p32p33,3))]}, ...
%             'Color',[0 0 1])
%         text(1.3, f_sub1.YLim(2)*0.25, ...
%             {'p33vsp32', ['z = ' num2str(round(stats_R31_p32p33.zval,3)) '; p = ' num2str(round(p_R31_p32p33,3))]}, ...
%             'Color',[1 0 0])
%         text(2.3, f_sub1.YLim(2)*0.75, ...
%              {'p34vsp32', ['z = ' num2str(round(stats_R13_p32p34.zval,3)) '; p = ' num2str(round(p_R13_p32p34,3))]}, ...
%             'Color',[0 0 1])
%         text(2.3, f_sub1.YLim(2)*0.25, ...
%             {'p34vsp32', ['z = ' num2str(round(stats_R31_p32p34.zval,3)) '; p = ' num2str(round(p_R31_p32p34,3))]}, ...
%             'Color',[1 0 0])        
% 
%         legend([anatreg{i_effect}.label_aggregated{temp_currfilt(1)} '->' ...
...
%         [p_R23_p32p33, h, stats_R23_p32p33] = ...
%             signrank(...
%             Gavg_tempGC_peranatreg.source2target{i_effect}...
...
%         [p_R23_p32p34, h, stats_R23_p32p34] = ...
%             signrank(...
%             Gavg_tempGC_peranatreg.source2target{i_effect}...
%             {temp_currfilt(2),temp_currfilt(3),i_TD}(:,1), ...
%             Gavg_tempGC_peranatreg.source2target{i_effect}...
...
%         [p_R32_p32p33, h, stats_R32_p32p33] = ...
%             signrank(...
%             Gavg_tempGC_peranatreg.source2target{i_effect}...
...
%         [p_R32_p32p34, h, stats_R32_p32p34] = ...
%             signrank(...
%             Gavg_tempGC_peranatreg.source2target{i_effect}...
%             {temp_currfilt(3),temp_currfilt(2),i_TD}(:,1), ...
%             Gavg_tempGC_peranatreg.source2target{i_effect}...
...
%         hold on;
%         text(1.3, f_sub1.YLim(2)*0.75, ...
%             {'p33vsp32', ['z = ' num2str(round(stats_R23_p32p33.zval,3)) '; p = ' num2str(round(p_R23_p32p33,3))]}, ...
%             'Color',[0 0 1])
%         text(1.3, f_sub1.YLim(2)*0.25, ...
%             {'p33vsp32', ['z = ' num2str(round(stats_R32_p32p33.zval,3)) '; p = ' num2str(round(p_R32_p32p33,3))]}, ...
%             'Color',[1 0 0])
%         text(2.3, f_sub1.YLim(2)*0.75, ...
%              {'p34vsp32', ['z = ' num2str(round(stats_R23_p32p34.zval,3)) '; p = ' num2str(round(p_R23_p32p34,3))]}, ...
%             'Color',[0 0 1])
%         text(2.3, f_sub1.YLim(2)*0.25, ...
%             {'p34vsp32', ['z = ' num2str(round(stats_R32_p32p34.zval,3)) '; p = ' num2str(round(p_R32_p32p34,3))]}, ...
%             'Color',[1 0 0])        
% 
