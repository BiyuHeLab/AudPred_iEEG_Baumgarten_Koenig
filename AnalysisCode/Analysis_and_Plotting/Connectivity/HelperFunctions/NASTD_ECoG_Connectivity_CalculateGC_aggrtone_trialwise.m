...
sub = sub_list{i_sub};
disp(['Computing GC for subject: ' sub])
...
for i_effect = 1:length(param.GC.ElecPairEffect)
    ...
    if SelElecs.Pairs.(param.GC.ElecPairEffect{i_effect}).(...
        ...
        for i_TD = 1:length(ToneDur_text)
            ...
            %Set structs for Output parameters (dim: source elec * target elec * nTones * nTrials)
                    ...
                    if ind_pairedelecs_from{i_effect}(i_sourceelec) ~= ind_pairedelecs_to{i_effect}(i_targetelec)
                        ...
                        for i_tonegroup = 1:size(param.GC.tone_aggregation,2)
                            for i_trial = 1:nTrials
                                ...
                                validA{i_effect}{i_TD}(i_sourceelec, i_targetelec, i_tonegroup, i_trial) = ...
                                ...
                                validF{i_effect}{i_TD}...
                                    (i_sourceelec,i_targetelec, i_tonegroup,i_trial) = ...
                                    ~isbad(FS.F,false);
                                ...
                                if validF{i_effect}{i_TD}(i_sourceelec, i_targetelec, i_tonegroup, i_trial) == 1
                                    ...
                                    temporalGC{i_effect}{i_TD}.source2target...
                                        (i_sourceelec,i_targetelec,i_tonegroup,i_trial) ...%(Source elec, Target elec, Tone)
                                        = FS.F(2,1);
                                    temporalGC_pval{i_effect}{i_TD}.source2target...
                                        (i_sourceelec,i_targetelec,i_tonegroup,i_trial) ...%(Source elec, Target elec, Tone)
                                        = FS.pval(2,1);
                                    frequencyGC{i_effect}{i_TD}.source2target...
                                        (i_sourceelec,i_targetelec,:,i_tonegroup,i_trial) ...%(Source elec, Target elec, Frequency, Tone)
                                        = FS.f(2,1,:);
                                    
                                    %Direction target -> source
                                    temporalGC{i_effect}{i_TD}.target2source...
                                        (i_sourceelec,i_targetelec,i_tonegroup,i_trial) ...%(Target elec, Source elec, Tone)
                                        = FS.F(1,2);
                                    temporalGC_pval{i_effect}{i_TD}.target2source...
                                        (i_sourceelec,i_targetelec,i_tonegroup,i_trial) ...%(Target elec, Source elec, Tone)
                                        = FS.pval(1,2);
                                    frequencyGC{i_effect}{i_TD}.target2source...
                                        (i_sourceelec,i_targetelec,:,i_tonegroup,i_trial) ...%(Target elec, Source elec, Frequency, Tone)
                                        = FS.f(1,2,:);
