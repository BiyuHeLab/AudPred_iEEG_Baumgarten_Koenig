function c = NASTD_ECoG_Plot_SubplotSignElecsSurf_SubplotLH_avgTW...
...
if CounterSubplot == 1
    ...
    h.Position(2) = 0.35; %sets colorbar higher
    h.Position(4) = h.Position(4)*0.4; %makes colorbar shorter
...
chanSize_nonsignElec = chanSize/2.5%3;
