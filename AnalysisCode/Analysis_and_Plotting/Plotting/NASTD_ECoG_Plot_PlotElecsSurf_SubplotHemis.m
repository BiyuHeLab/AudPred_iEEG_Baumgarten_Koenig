function c = NASTD_ECoG_Plot_PlotElecsSurf_SubplotHemis(coords,vals,chanSize,clims,cmap)
            %NASTD_ECoG_Plot_PlotElecsSurf_SubplotHemis(coords,vals,chanSize,clims,cmap,inputData,ToneDur_text,PlottedComparison)
% %% Test input data
...
h = colorbar;
h.Position(1) = 0.525; %sets colorbar between subplots
h.Position(2) = 0.325; %sets colorbar higher
h.Position(4) = h.Position(4)*0.5; %makes colorbar shorter
