function NASTD_ECoG_Predict_PlotSignClusterElec_AllSubTD_FDR_Uncorr...
    (subs, ...
...
outdir = [paths_NASTD_ECoG.ECoGdata_Prediction ...
    '/PredEffects/Allsub_n' num2str(length(subs)) '/SignElecs/'];

if ~exist(outdir, 'dir'); mkdir(outdir); end

save([outdir 'SignElecs_' FuncInput_DataType '_' FDR_label '.mat'], ...
    'SignElecs', 'Param2plot', 'labels_allsub');
