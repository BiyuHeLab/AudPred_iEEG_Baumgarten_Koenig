function NASTD_ECoG_Predict_PlotSignClusterElec_AllSubTD_FDR_Uncorr_FTPL...
    (subs, ...
...
switch FuncInput_EffectType
    case 'PredErrFTPL'
        effect_text = ['Effect: Prediction (explain p34 activity by FTPL rating); p < ' num2str(param.pval_plotting) ' ' FDR_label];
end
