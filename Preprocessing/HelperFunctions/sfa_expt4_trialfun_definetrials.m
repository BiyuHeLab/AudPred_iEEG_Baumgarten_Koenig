function [trial] = sfa_expt4_trialfun_definetrials(data_ECoGfiltref_blocks,offset_inSamples)
...
for i_blocktrigger = 1:length(trigger_info.Exp.BlockStart_index)
    ...
    TrialCounter = TrialCounter+1;
       trialbegin_index = trigger_info.Exp.TrialStart_index{i_blocktrigger}(i_trialtrigger)-offset_inSamples;  %trial begin is defined by blockstart trigger - offset 
       ...
       %sequence.
       trialend_index = trigger_info.Exp.TrialEnd_index{i_blocktrigger}(i_trialtrigger)+additionalsamples4trialend+offset_inSamples;  
