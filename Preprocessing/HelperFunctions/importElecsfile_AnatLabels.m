function [RO01,VarName2,VarName3,VarName4,RO02] = importElecsfile_AnatLabels(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [RO01,VARNAME2,VARNAME3,VARNAME4] = IMPORTFILE(FILENAME) Reads data
%   from text file FILENAME for the default selection.
%
%   [RO01,VARNAME2,VARNAME3,VARNAME4] = IMPORTFILE(FILENAME, STARTROW,
%   ENDROW) Reads data from rows STARTROW through ENDROW of text file
%   FILENAME.
%
% Example:
%   [RO01,VarName2,VarName3,VarName4] = importfile('NY559_fmri_012115_T1_rh_split_STG_MTG_AnatomicalRegions.txt',1, 61);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/04/11 09:46:46
